    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-left" href="/">
                <img src="${pageContext.request.contextPath}/../../../../../platform/src/main/webapp/assets/logo/logo.svg" alt="The SMESEC project"/>
            </a>
        </div>
        <div class="clear"></div>
    ...
    <div class="container">
        ...
        <div class="text-container">
            ...
            <div class="context primary-text-color">
                <p>Something about your request wasn't proper.If you're authenticating with Keycloak, make sure to verify your oidc account includes the following claims:</p>
                <ul>
                    <li>Company</li>
                    <li>Username</li>
                    <li>Email address</li>
