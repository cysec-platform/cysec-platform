    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-left" href="/">
                <img src="${pageContext.request.contextPath}/assets/logo/logo.svg" alt="The SMESEC project"/>
            </a>
        </div>
        <div class="clear"></div>
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav" id="navbar">
              ...
              <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Framework</a>
                  <ul class="dropdown-menu">
                      <li><a href="../cybersecurity.html">Cybersecurity and SMEs</a></li>
                      <li><a href="../framework.html">SMESEC Framework</a></li>
                  </ul>
              </li>
              <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Project</a>
                  <ul class="dropdown-menu">
                      <li><a href="../about.html">About SMESEC</a></li>
              ...
              <li><a href="https://smesec.eu/contact"  target="_blank">Contact</a></li>
            </ul>
            -->
        </div><!--/.nav-collapse -->
    </div>
...
<div class="wrap">
    <div class="container">
        ...
        <div class="text-container">
            ...
            <div class="context primary-text-color" style="font-size: 8px">
