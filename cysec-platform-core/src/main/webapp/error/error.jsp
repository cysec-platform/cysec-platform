<%--
  ...
  CYSEC Platform Core
  %%
  Copyright (C) 2020 - 2026 FHNW (University of Applied Sciences and Arts Northwestern Switzerland)
  %%
...
<article>
    ...
    <h1>Hmmm! That doesnt looks good!</h1>
    <div>
        <p>When youre moving, youre stressed. This page probably doesnt help with that, even though its pretty cute.
    </div>
</article>
