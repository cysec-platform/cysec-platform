...
/**
 * <p>Password storage implementation for linux type crypt passwords.</p>
 */
public class CryptPasswordStorage extends PasswordStorage {
   ...
   * @throws IllegalArgumentException if salt is an empty String
   */
  public CryptPasswordStorage(String storageString)
          throws NoSuchAlgorithmException {
    super(storageString);
    if (getType() == null) {
  ...
  /***
   * <p>Gets the current crypt type.</p>
   *
