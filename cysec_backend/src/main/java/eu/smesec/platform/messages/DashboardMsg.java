...
public class DashboardMsg extends Message {
  public DashboardMsg(Locale locale, int instantiated, int remaining, int badegs) {
    super(locale);
    ...
    messages.put("noRecommendationInfo", i18n.tr("Later you will see recommended next steps displayed here"));
    ...
    messages.put("latestAchievements", i18n.trn("latest achievement", "latest achievements", badegs));
