...
import eu.smesec.platform.auth.PasswordStorageTest;

import eu.smesec.platform.auth.strategies.BasicAuthStrategyTest;
import eu.smesec.platform.auth.strategies.HeaderAuthStrategyTest;
import eu.smesec.platform.auth.strategies.ReplicaAuthStrategyTest;
